...
import edu.ort.dcomp.fint.jsf.util.JsfUtil;
import edu.ort.dcomp.fint.jsf.util.PaginationHelper;
...
public class TransaccionController {
    ...
    @EJB private edu.ort.dcomp.fint.jsf.TransaccionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/temp").getString("TransaccionCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/temp").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/temp").getString("TransaccionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/temp").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/temp").getString("TransaccionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/temp").getString("PersistenceErrorOccured"));
        }
    }
