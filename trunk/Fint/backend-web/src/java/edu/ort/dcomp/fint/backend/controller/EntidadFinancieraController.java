...
public class EntidadFinancieraController {
    ...
    private EntidadFinanciera current;
    private DataModel items = null;
    @EJB private EntidadFinancieraManagerLocal ejbFacade;
    ...
    private EntidadFinancieraManagerLocal getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (EntidadFinanciera)getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntidadFinancieraCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntidadFinancieraUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntidadFinancieraDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class EntidadFinancieraControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EntidadFinanciera) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+EntidadFinancieraController.class.getName());
            }
        }
