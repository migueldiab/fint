...
public class ReciboController {
    ...
    @EJB private edu.ort.dcomp.ute.managers.ReciboFacade ejbFacade;
    ...
    public static class ReciboControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Recibo) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+ReciboController.class.getName());
            }
        }
